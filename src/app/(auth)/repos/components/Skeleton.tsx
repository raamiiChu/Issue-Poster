                ...
                return (
                    ...
                    >
                        ...
                        <section className="col-span-6 hidden md:grid grid-cols-3">
                            <div className="col-start-3 rounded text-transparent bg-slate-500 dark:bg-slate-300">
                                Issues: 0
                            </div>
                        </section>

                        <p className="hidden md:block col-span-full text-sm line-clamp-2 bg-slate-500 dark:bg-slate-300">
                            description
                        </p>
                        ...
                        <section className="col-span-full flex justify-center md:justify-between">
                            ...
                            <small className="hidden md:block text-sm bg-slate-500 dark:bg-slate-300">
